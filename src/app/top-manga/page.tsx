...
export const metadata: Metadata = {
  ...
  description:
    "Browse the highest-rated and most popular manga. Filter by genre, format, and status.",
};
...
export default async function TopMangaPage({
  searchParams,
}: {
  ...
  const [result, genres] = await Promise.all([
    getMangaPage({ page, perPage: PER_PAGE, sort, status, genres: selectedGenres.length ? selectedGenres : null, format }).catch(
      (err) => {
        ...
        <section className="relative overflow-hidden border-b border-border">
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
            ...
            <p className="mt-4 max-w-2xl text-base text-muted">
              The highest-rated and most popular manga, curated by the community.
